    ...
    <div class="row g-3">
        <div class="col-md-4">
            <div class="card-premium p-3 text-center">
                <i class="bi bi-trophy fs-2 mb-2 text-gold"></i>
                <h6 class="mb-1 text-white">STARTER TIER</h6>
                <h4 class="mb-2 text-gold">30%</h4>
                <small class="text-light">0-10 orders/month</small>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card-premium p-3 text-center">
                <i class="bi bi-trophy-fill fs-2 mb-2 text-gold"></i>
                <h6 class="mb-1 text-white">PRO TIER</h6>
                <h4 class="mb-2 text-gold">40%</h4>
        ...
        <div class="col-md-4">
            <div class="card-premium p-3 text-center">
                <i class="bi bi-trophy-fill fs-2 mb-2 text-gold"></i>
                <h6 class="mb-1 text-white">EXPERT TIER</h6>
                <h4 class="mb-2 text-gold">50% + 5% Bonus</h4>
                <small class="text-light">50+ orders/month</small>
            </div>
        </div>
    </div>
</div>
